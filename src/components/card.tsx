  ...
  createCard() {
    this.loader.load("/fonts/Roboto_Regular.json", (font) => {
      ...
      if (this.content !== "") {
        ...
        divider.rotation.set(this.rotation.x, this.rotation.y, this.rotation.z);
      ...
      if (this.isBorder) {
        ...
        const borderMaterial = new THREE.LineBasicMaterial({ color: 0xb0e7ff });
      ...
      backPanel.rotation.set(this.rotation.x, this.rotation.y, this.rotation.z);
